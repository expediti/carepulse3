...
export const AppointmentForm: React.FC<AppointmentFormProps> = ({ onCancel, onSubmit }) => {
  ...
  const handleConfirm = () => {
    if (selectedDoctor && selectedDate && selectedTime) {
      onSubmit({
        patientId: '', // Filled by context
        patientName: '', // Filled by context
  ...
  return (
    <div className="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl border border-slate-100">
      {/* Header */}
